...
const changeSetDone = (teks, groupID, _db) => {
    ...
    if (position !== null) {
        ...
        fs.writeFileSync('./src/grub/set_done.json', JSON.stringify(_db, null, 3))
    }
}
...
const changeSetProses = (teks, groupID, _db) => {
    ...
    if (position !== null) {
        _db[position].text = teks
        fs.writeFileSync('./src/grub/set_proses.json', JSON.stringify(_db, null, 3))
    }
}
...
const changeSetClose = (teks, groupID, _db) => {
    ...
    if (position !== null) {
        _db[position].text = teks
        fs.writeFileSync('./src/grub/set_close.json', JSON.stringify(_db, null, 3))
    }
}
...
const changeSetOpen = (teks, groupID, _db) => {
    ...
    if (position !== null) {
        _db[position].text = teks
        fs.writeFileSync('./src/grub/set_open.json', JSON.stringify(_db, null, 3))
    }
}
...
const changeSetWelcome = (teks, groupID, _db) => {
    ...
    if (position !== null) {
        _db[position].text = teks
        fs.writeFileSync('./src/grub/set_welcome.json', JSON.stringify(_db, null, 3))
    }
}
...
const changeSetLeft = (teks, groupID, _db) => {
    ...
    if (position !== null) {
        _db[position].text = teks
        fs.writeFileSync('./src/grub/set_left.json', JSON.stringify(_db, null, 3))
    }
}
...
const addSewaGroup = (gid, expired, _dir) => {
    ...
    _dir.push(obj)
    fs.writeFileSync('./src/grub/sewa.json', JSON.stringify(_dir, null, 2))
}
