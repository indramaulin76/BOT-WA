...
function renameResponList(groupID, oldKey, newKey, _db) {
    let position = null;
    Object.keys(_db).forEach((x) => {
...
module.exports = { addResponList, delResponList, isAlreadyResponList, isAlreadyResponListGroup, sendResponList, updateResponList, getDataResponList, renameResponList }